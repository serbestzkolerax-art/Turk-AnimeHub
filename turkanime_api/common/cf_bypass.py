...
try:
    ...
    # HARD DISABLED: QtWebEngine hangs on Windows offscreen and spawns orphaned processes!
...
class CFSession:
    ...
    # Varsayılan FlareSolverr adresi (Artık web.py üzerinden yerel olarak başlatılıyor)
    DEFAULT_FLARESOLVERR_URL = "http://127.0.0.1:8191"
    ...
    def _try_flaresolverr(self, url: str, method: str = "GET", post_data: Optional[str] = None) -> Optional[requests.Response]:
        ...
        try:
            ...
            print(f"[CF Bypass] FlareSolverr sunucusuna bağlanılamadı ({e}) — bu oturumda tekrar denenmeyecek")
